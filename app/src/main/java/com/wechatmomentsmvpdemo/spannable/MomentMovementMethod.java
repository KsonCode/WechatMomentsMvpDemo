package com.wechatmomentsmvpdemo.spannable;
 ...
 * @date 16/1/2 16:54
 */
public class MomentMovementMethod extends BaseMovementMethod {
    public final String TAG = MomentMovementMethod.class.getSimpleName();
    ...
    public MomentMovementMethod(){
        this.textViewBgColor = AppUtils.getAppContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = AppUtils.getAppContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
     ...
     */
    public MomentMovementMethod(int clickableSpanBgClor){
     ...
     */
    public MomentMovementMethod(int clickableSpanBgClor, int textViewBgColor){
