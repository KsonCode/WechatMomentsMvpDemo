package com.wechatmomentsmvpdemo.widgets;
...
import com.wechatmomentsmvpdemo.spannable.MomentMovementMethod;
import com.wechatmomentsmvpdemo.spannable.SpannableClickable;
...
public class CommentListView extends LinearLayout {
    ...
    private View getView(final int position){
        ...
        final MomentMovementMethod circleMovementMethod = new MomentMovementMethod(itemSelectorColor, itemSelectorColor);
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor){
                                    ...
                                    public void onClick(View widget) {
                                        Toast.makeText(AppUtils.getAppContext(), textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
                                    }
