...
public class PraiseListView extends TextView {
    ...
    public void notifyDataSetChanged(){
        ...
        setText(builder);
        setMovementMethod(new MomentMovementMethod(itemSelectorColor));
    }
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(AppUtils.getAppContext(), R.drawable.icon_praise, DynamicDrawableSpan.ALIGN_BASELINE),
